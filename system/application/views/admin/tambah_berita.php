<div class="pad20">
    ...
    <div id="tabs">
        ...
        <div id="tabs-1">
            <!-- Form -->
            <form method="post" action="../index.php/admin/berita/insert">
                <!-- Fieldset -->
                <fieldset>
                    <p>
                    ...
                    <p>
                        <input class="button" type="submit" value="Terbitkan" name="submit" /> <a href="../index.php/admin/front">Ke Daftar Berita</a>
                    </p>
                </fieldset>
                <!-- End of fieldset -->
            </form>
